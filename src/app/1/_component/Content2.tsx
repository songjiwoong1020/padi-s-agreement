...
export default function Content2 ({inputRef}: {inputRef: React.RefObject<HTMLInputElement> | React.RefObject<null>}) {
  return (
    <>
      <b>수중사진, 지상사진, 동영상 초상권 면책 동의서</b><br/>
      본인(수강생 이름).<input className={styles['name-input']} placeholder="홍길동" ref={inputRef}/>은(는) 스킨 스쿠버 다이빙 진행 중, 촬영된 수중사진,
